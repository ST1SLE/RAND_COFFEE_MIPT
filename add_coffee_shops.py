...
COFFEE_SHOPS_SOURCE_DATA = [
    ...
    },
    {
        "id": 6,
        "name": "Теория Цифра",
        "desc": "-1 этаж корпуса Физтех.Цифра"k,
    ...
    {
        "id": 8,
        "name": "Кофейня переход ГК НК",
        "desc": "2 этаж НК, рядом с переходом в ГК",
        "schedule": {"Пн-Пт": "09:00-19:00", "Сб": "09:00-17:00"},
    },
    {
        "id": 9,
        "name": "Адрон",
    ...
    {
        "id": 17,
        "name": "Кофейня переход ГК Цифра",
        "desc": "2 этаж корпуса Физтех.Цифра, рядом с переходом в ГК",
